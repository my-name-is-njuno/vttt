            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="" action="{{ route('candidates.update', $candidate->id) }}" method="post">
                        ...
                        <input type="hidden" name="country_id" value="{{ $candidate->country_id }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agenda" id="agenda" cols="30" rows="10"
                                class="form-control {{ $errors->has('agenda') ? 'is-invalid' : '' }}">{{ $candidate->agenda->agendas }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="promises" id="promises" cols="30" rows="10"
                                class="form-control {{ $errors->has('promises') ? 'is-invalid' : '' }}">{{ $candidate->promise->promises  }}</textarea>

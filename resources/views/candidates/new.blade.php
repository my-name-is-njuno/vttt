                    ...
                    <form class="" action="{{ route('candidates.update', $candidate->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="dob" id="dob"
                                ...
                                placeholder="candidate dob" aria-describedby="helpId"
                                value="{{ old('dob') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="place_name" id="place_name"
                                ...
                                placeholder="candidate place_name" aria-describedby="helpId"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="running_as" id="running_as"
                                class="form-control {{ $errors->has('running_as') ? 'is-invalid' : '' }}"
                                placeholder="candidate running_as" aria-describedby="helpId"
                                value="{{ old('running_as') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="political_party" id="political_party"
                                class="form-control {{ $errors->has('political_party') ? 'is-invalid' : '' }}"
                                placeholder="candidate political_party" aria-describedby="helpId"
                                value="{{ old('political_party') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="agenda" id="agenda" cols="30" rows="10"
                                class="form-control {{ $errors->has('agenda') ? 'is-invalid' : '' }}">{{ old('agenda') }}</textarea>
